...
/// Signature of the per-ad event sink registered with [InMobiAdsPlatform].
typedef InMobiAdEventHandler = void Function(
  String event,
...
///
/// Both InMobi SDKs deliver events through a listener bound to an ad instance,
/// not to a request. Flutter has no handle to a native object, so every ad gets
/// an integer id minted here, passed down at creation, and echoed back on every
